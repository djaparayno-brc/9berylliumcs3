...
In my perspective, the most important property is "name" because you cannot point out or distinguish musical instruments without giving them a name. For example; viola and violin; those two almost look the same, right? Their names are the ones that make them distinct to each other. It's just like giving twins different names to differentiate them.
